...
This is a simple addon for [vicinae](https://github.com/vicinaehq/vicinae)
adding a menu where you can search through your Firefox bookmarks, either
opening it in your browser or copying it to your clipboard.
...
You can select your install method in the preferences and a custom profile
override if necessary.

The addon supports the following Firefox derivatives:
...
Please note that some of the above options may not have a Flatpak or Snap
option.
